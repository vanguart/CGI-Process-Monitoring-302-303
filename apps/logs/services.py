...
def createLogFiles(creds, key, header, newQueueProcess):
    ...
    newLogTxt.write("TimeStamp\tPlataform\tLogType\tMessage\tProcessID\n")
    ...
    for log in range(0, countAllLogs):
        ...
        newLogTxt.write(timeStampDate + " " + timeStampTime + "\t" + "Uipath Orchestrator" + "\t" + logType + "\t" + message + "\t" + str(newQueueProcess.id) +"\n")
